...
近期留意到部分关于对照实验效果的讨论，非常感谢业界同行的关注 —— 事实上，我们在开源数据体系的搭建中已投入大量精力（相关数据集及预处理流程均已公开），也期待与大家就技术细节展开更深入的沟通。

我们深知开源工作仍有迭代空间，若在实验设计或数据处理中存在考虑不周之处，真诚欢迎前辈与同行通过 GitHub 等渠道不吝赐教（能力有限，轻喷哦～☺️🤝）。
