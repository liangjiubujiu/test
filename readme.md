...
目前，我们已整理相关工作并开源供算法研究者参考。近期，有人在未与我们事先沟通的情况下，就对照实验效果提出质疑，忽视了我们在数据开源上的贡献。欢迎通过GitHub与我们联系，共同推动牙齿开源数据和算法社区的发展。我们深知当前工作仍有改进空间，若有考虑不周之处，也请各位前辈与同行不吝赐教（能力有限，轻喷哦～☺️🤝）。
