...
class UnetConv3(nn.Module):
    def __init__(self, in_size, out_size, is_batchnorm, kernel_size=(3, 3, 3), padding_size=(1, 1, 1),
        ...
        if is_batchnorm:
            self.conv1 = nn.Sequential(nn.InstanceNorm3d(out_size),
                                       nn.ReLU(inplace=True),
            ...
            self.conv4 = nn.Sequential(nn.Conv3d(out_size, out_size, kernel_size, 2, padding_size),
                                       nn.ReLU(inplace=True),
                                       )
    ...
    def forward(self, inputs):
        ...
        outputs = self.dropout3d(outputs)
