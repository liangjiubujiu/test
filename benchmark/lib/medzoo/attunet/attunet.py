...
class AttUnet3D(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3,
        ...
        #todo
        self.center = UnetConv3(filters[2], filters[3], self.is_batchnorm, kernel_size=(3, 3, 3),
                                padding_size=(1, 1, 1))
        self.gating = UnetGridGatingSignal3(filters[3], filters[3], kernel_size=(1, 1, 1),
    ...
    def forward(self, inputs):
        ...
        #todo
        # print('gating conv3',gating.shape,conv3.shape)
        g_conv3, att3 = self.attentionblock3(conv3, gating)
        # print('atten1  g_conv3 atten3',g_conv3.shape,att3.shape)
        # print('center',center.shape)
        up3 = self.up_concat3(g_conv3, center)
        # print('*******************')
        # print('conv2 up3', conv2.shape,up3.shape)

        g_conv2, att2 = self.attentionblock2(conv2, up3)
        # print('atten2  g_conv2 atten2', g_conv2.shape, att2.shape)
