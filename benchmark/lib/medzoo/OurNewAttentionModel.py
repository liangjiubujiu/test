...
from attention3s import ShuffleAttention


class OurNewAttentionModel(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3,
        ...
        super(OurNewAttentionModel, self).__init__()
        ...
        # todo: register the attention module here. For example, you choose shuffle attention then
        self.attention = ShuffleAttention(channel=filters[2], reduction=filters[2] // 4)
    ...
    def forward(self, inputs):
        ...
        # Attention Mechanism
        g_conv2 = conv2
        g_center = self.attention(center)
