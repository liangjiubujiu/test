...
from .TransBTS.TransBTS.Transformer import TransformerModel
...
class Transmini(BaseModel):
    """
    Implementations based on the Unet3D paper: https://arxiv.org/abs/1606.06650
    """

    def __init__(self, in_channels, n_classes, base_n_filter=8):
        super(Transmini, self).__init__()
        ...
        self.trans1 = self.norm_lrelu_upscale_conv_norm_lrelu(512,256)

        self.trans2 = self.norm_lrelu_upscale_conv_norm_lrelu(256,128)

        self.trans3 = self.norm_lrelu_upscale_conv_norm_lrelu(128,64)
        self.trans4 = self.norm_lrelu_upscale_conv_norm_lrelu(64,32)
        self.trans5 = self.norm_lrelu_upscale_conv_norm_lrelu(32,16)
    ...
    def forward(self, x):
        ...
        # print("combination")
        # print(ds2_1x1_conv.shape)
        # print(ds1_ds2_sum_upscale.shape)
        # print( ds3_1x1_conv.shape)
        # print( ds1_ds2_sum_upscale_ds3_sum.shape)
        # print('ds1_ds2_sum_upscale_ds3_sum_upscale.shape',ds1_ds2_sum_upscale_ds3_sum_upscale.shape)

        out = out_pred + ds1_ds2_sum_upscale_ds3_sum_upscale
        print('out',out.shape)
        x = out.permute(0, 2, 3, 4, 1).contiguous()
        # print('permute x shape', x.shape)
        x = x.view(x.size(0), -1, 512)
        print('view x size',x.shape)
        ...
        # for key, value in intmd_x.items():
            # print('key',key)
        ...
        x8 = x8.view(x8.size(0),2 ,32,32,512)
        x8 = x8.permute(0, 4, 1,2, 3).contiguous()
