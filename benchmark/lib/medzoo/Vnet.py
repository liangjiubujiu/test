...
class VNetLight(BaseModel):
    ...
    def __init__(self, elu=True, in_channels=1, classes=4):
        ...
        # self.up_tr64 = UpTransition(128, 64, 1, elu)
        self.up_tr64=UpTransition(64, 64, 2, elu)
        self.up_tr32 = UpTransition(64, 32, 1, elu)
        self.out_tr = OutputTransition(32, classes, elu)

        self.conv3d_1x1 = nn.Conv3d(64, classes, kernel_size=1, stride=1, padding=0,
                                        bias=False)
    ...
    def forward(self, x):
        ...
        out64 = self.down_tr64(out32)
        # out128 = self.down_tr128(out64)
        # outup64 = self.up_tr128(out128, out64)
        outup32 = self.up_tr64(out64, out32)
        outup16 = self.up_tr32(outup32, out16)
        out = self.out_tr(outup16)
        # print('out', out.shape)
        a = self.conv3d_1x1(outup32)
        # print('a',a.shape)
        b= self.upsacle(a)
        # print('b', b.shape)
        return out+b
